...
-- Design Ports Information
-- newclock	=>  Location: PIN_P8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
\newclock~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
...
-- Equation(s):
-- \counter~3_combout\ = (\Add0~12_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~1_combout\ = (\Add0~24_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~0_combout\ = (\Add0~26_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~4_combout\ = (\Add0~28_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~6_combout\ = (!\Equal0~10_combout\ & \Add0~36_combout\)
...
-- Equation(s):
-- \counter~7_combout\ = (!\Equal0~10_combout\ & \Add0~38_combout\)
...
-- Equation(s):
-- \counter~8_combout\ = (\Add0~40_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~9_combout\ = (\Add0~42_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~10_combout\ = (\Add0~44_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~11_combout\ = (!\Equal0~10_combout\ & \Add0~48_combout\)
...
-- Equation(s):
-- \Equal0~8_combout\ = (!counter(26) & (!counter(27) & (counter(24) & !counter(25))))
...
-- Equation(s):
-- \Equal0~9_combout\ = (!counter(31) & (!counter(29) & (!counter(28) & !counter(30))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!counter(6) & (!counter(8) & (!counter(7) & !counter(9))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (counter(12) & (counter(11) & (!counter(10) & counter(13))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (counter(14) & (counter(0) & (!counter(15) & counter(1))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (counter(2) & (counter(4) & (counter(5) & counter(3))))
...
-- Equation(s):
-- \Equal0~7_combout\ = (\Equal0~6_combout\ & (counter(22) & (!counter(23) & \Equal0~5_combout\)))
...
-- Equation(s):
-- \clk~0_combout\ = \clk~q\ $ (\Equal0~10_combout\)
